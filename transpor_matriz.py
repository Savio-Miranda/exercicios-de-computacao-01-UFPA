...
matriz_quadrada_teste_nao_aleatoria = [[9, 2, 2, 2], [1, 1, 1, 1], [1, 1, 2, 1], [1, 1, 1, 9]]

matriz_quadrada_aleatoria = criar_matriz_quadrada_aleatoria(3, 5)
minha_matriz, elementos = transpor_matriz(matriz_quadrada_teste_nao_aleatoria)

print("matriz quadrada aleatória:")
...
for i in minha_matriz:
    print(i)
print("elementos acima da media: ", elementos)